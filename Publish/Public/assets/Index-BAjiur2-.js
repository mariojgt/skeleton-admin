          ...
          if (_push2) {
            ...
            return [
              createVNode(Table, {
                ...
                permission: props.permission,
                custom_edit_route: props.custom_edit_route
              }, null, 8, ["columns", "model", "endpoint", "endpoint-delete", "endpoint-create", "endpoint-edit", "table-title", "permission", "custom_edit_route"])
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/vendor/SkeletonAdmin/js/backend/Pages/BackEnd/Vendor/GameDev/Generic/Index.vue");
