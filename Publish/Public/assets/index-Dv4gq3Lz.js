function a(e,s,t){const o={info:{class:"alert-info",icon:`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-10 h-10">
    ...
    `}const m=(e,s)=>a("info",e,s),u=(e,s)=>a("error",e,s),w=(e,s)=>a("warning",e,s),f=(e,s)=>a("success",e,s),k=async(e,s,t,o=10,r="right",c=1e4)=>{if(typeof window>"u")return;const i=document.querySelector("body"),d="wind-notify-"+r;let n=document.getElementById(d);n||(n=document.createElement("div"),n.id=d,i.appendChild(n)),v(n,r,c);const l=document.createElement("div");switch(l.className="p-3 block transform transition-all duration-150 ease-out scale-0",n.appendChild(l),p(l),t){case"info":l.innerHTML=m(e,s);break;case"error":l.innerHTML=u(e,s);break;case"success":l.innerHTML=f(e,s);break;default:l.innerHTML=w(e,s);break}h(l,o)};function v(e,s,t=1e4){switch(e.style.position="fixed",e.style.zIndex=t,e.style.width="300px",s){case"left":e.style.top="50%",e.style.transform="translateY(-50%)",e.style.left="1rem";break;case"right":e.style.top="50%",e.style.transform="translateY(-50%)",e.style.right="1rem";break;case"top":e.style.top="1rem",e.style.left="50%",e.style.transform="translateX(-50%)";break;case"bottom":e.style.bottom="1rem",e.style.left="50%",e.style.transform="translateX(-50%)";break;case"middle":e.style.top="50%",e.style.left="50%",e.style.transform="translate(-50%, -50%)";break;default:e.style.bottom="1rem",e.style.right="1rem";break}e.style.maxHeight="calc(100vh - 2rem)",e.style.overflowY="auto"}function p(e){setTimeout(()=>{e.classList.remove("scale-0"),e.classList.add("scale-100")},200)}function h(e,s){const t=e.querySelector(".progress");if(!t)return;const o=s*60;let r=0;const c=()=>{const i=Math.min((r/o)**.5*100,100);t.value=i,r>=o?(e.classList.add("scale-0"),setTimeout(()=>{e.remove()},200)):(r++,requestAnimationFrame(c))};c()}function g(e){e.target.parentElement.parentElement.parentElement.parentElement.parentElement.remove()}typeof window<"u"&&(window.removeWindToast=g);export{k as s};
