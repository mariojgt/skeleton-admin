...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const submitForm = () => {
      ...
      Inertia.patch(route("admin.update-password", adminInformation.value.id), form);
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/vendor/SkeletonAdmin/js/backend/Pages/BackEnd/Vendor/GameDev/Instructor/Components/Instructor.vue");
