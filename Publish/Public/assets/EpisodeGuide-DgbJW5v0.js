...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "panel relative transition-colors duration-300 bg-dark-blue-100 py-4 rounded-xl px-8 mt-3" }, _attrs))}><div class="container"><div class="left flex flex-1 gap-x-4"><div class="flex items-center text-xs font-medium">`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/vendor/SkeletonAdmin/js/frontend/Pages/FrontEnd/Vendor/GameDev/Store/ViewComponents/EpisodeGuide.vue");
