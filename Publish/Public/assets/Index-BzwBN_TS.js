              ...
              createVNode("div", { class: "grid grid-cols-1 gap-6 lg:p-10 xl:grid-cols-3 lg:bg-base-200 rounded-box" }, [
                ...
                createVNode("div", { class: "card col-span-1 row-span-3 shadow-lg xl:col-span-2 bg-base-100" }, [
                  createVNode("div", { class: "card-body" }, [
                    createVNode("h2", { class: "my-4 text-4xl font-bold card-title" }, " Top 10 UI Components "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/vendor/SkeletonAdmin/js/frontend/Pages/FrontEnd/Dashboard/Index.vue");
