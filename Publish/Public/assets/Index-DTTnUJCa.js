          ...
          if (_push2) {
            ...
            return [
              createVNode(Table, {
                ...
                "table-title": "Permission",
                permission: props.permission
              }, null, 8, ["columns", "model", "endpoint", "endpoint-delete", "endpoint-create", "endpoint-edit", "permission"])
            ];
          }
        }),
        _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/vendor/SkeletonAdmin/js/backend/Pages/BackEnd/Permissions/Index.vue");
