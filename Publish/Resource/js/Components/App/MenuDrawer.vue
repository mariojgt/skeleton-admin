<template>
    <aside
        class="flex flex-col justify-start border-r border-base-200 bg-base-300 text-base-content w-80"
    >
        <div
            class="sticky inset-x-0 top-0 z-50 hidden w-full py-1 transition duration-200 ease-in-out border-b lg:block border-base-200 bg-base-300"
        >
            <div class="mx-auto space-x-1 navbar max-w-none">
                <div class="flex items-center flex-none">
                    ...
                    >
                        <div
                            class="inline-block text-3xl font-title text-primary"
                        >
                            <span class="lowercase">Skele</span
        ...
        <div>
            <ul class="menu flex flex-col p-4 pt-2">
                <li class="mt-4 menu-title"><span> New </span></li>
                <li>
