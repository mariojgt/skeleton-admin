        ...
        <div class="flex flex-col">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    <div
                        class="w-16 h-16 rounded-2xl border border-primary bg-base-100 flex justify-center"
                    >
                        <h1 class="p-4 text-xl text-white">
                            {{ lesson.order }}
                        </h1>
                    </div>
                    <div class="flex flex-col ml-3 p-5">
                        <div
                            class="font-medium leading-none text-xl"
                        >
                            {{ lesson?.name }}
                        </div>
                ...
                >
                    ...
                    <button class="btn btn-success" @click="suggestSlug">
                        Create Slug
                    </button>
            ...
            <div v-if="isOpen" class="flex flex-col">
                <div class="mx-auto w-full rounded-2xl bg-base-300 p-2 mt-5">
                    <Disclosure>
                        ...
                        <DisclosurePanel
                            class="px-4 pt-4 pb-2 bg-base-300 rounded-lg mt-5"
                        >
                            <input-field
                                v-model="lesson.name"
                                type="text"
                        ...
                        >
                            <div class="flex justify-between mb-5">
                                <div class="flex justify-between">
                                    <h1
                                        class="text-5xl leading-6 font-bold text-neutral-content pr-5"
                                    >
                                        Learning points
                                    </h1>
                                    <button class="btn">
                            ...
                            >
                                ...
                                />
                                <Youtube
                                    v-if="lesson.player_type === 'youtube'"
                                    width="1200"
                                    height="600"
                                    :videoId="lesson.video_id"
                                    :lesson-id="lesson.id"
                                    :seek="
                                        lesson?.lesson_progress?.watch_time
                                    "
                                    @video-lesson-points="lessonProgress"
                                />
                                <button
                                ...
                                <AddEditLearningPoint
                                    ...
                                    :secondsSync="lessonProgressSeconds"
                ...
                <button
                    class="btn bg-success text-black hover:bg-success mt-5"
