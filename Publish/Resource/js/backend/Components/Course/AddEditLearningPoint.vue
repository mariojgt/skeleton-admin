        ...
        <form class="flex-1" @submit.prevent="saveOrEditLessonPoint">
            ...
            >
                <div v-if="editingMode" class="mb-5">
                    <h1 class="card-title">Edit Learning Point</h1>
                </div>
                <div class="mb-5">
                    <input-field
                ...
                <h2 class="card-title mb-5">Lesson Content</h2>
                <Editor
                    v-model="lessonPointContent"
                    :api-key="props.apiKey"
                    :edit-model-value="lessonEditValue"
                />
                <button class="btn btn-success w-full mt-5" type="submit">
                    Save
                </button>
            </div>
        </form>
...
watch(
    ...
    (value) => {
        if (value) {
            lessonPointSeconds = value.toString();
        }
    }
);
</script>
