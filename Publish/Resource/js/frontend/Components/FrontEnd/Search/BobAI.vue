<template>
    <div class="w-full max-w-4xl bg-dark-200/95 backdrop-blur-sm rounded-xl shadow-2xl border border-dark-100/50 overflow-hidden">
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-4">
            <div class="relative">
              ...
              <div class="relative w-12 h-12 bg-blue-500/10 backdrop-blur-sm rounded-xl flex items-center justify-center group">
      ...
      <div
        v-if="showTips"
        class="bg-dark-300/50 border-b border-dark-100/50 px-6 py-4"
      >
      ...
      >
        ...
        >
          ...
          <div
            v-if="isLoading"
            key="loading"
            class="px-6 py-4 border-b border-dark-100/50"
          >
            <div class="flex space-x-4">
              <div class="flex-shrink-0">
    ...
    <div class="border-t border-dark-100/50 p-4 bg-gradient-to-b from-transparent to-dark-300/20">
        <form @submit.prevent="sendMessage" class="space-y-4">
            ...
            >
                <Hash class="w-4 h-4" />
                <span class="absolute -top-8 -left-1 bg-dark-400/90 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap">
                Markdown Support
                </span>
            </button>
            ...
            class="bg-dark-400/30 rounded-lg p-3 text-sm space-y-2 animate-fadeIn"
            >
            ...
            <textarea
                ...
                class="w-full bg-dark-300/50 text-gray-200 rounded-xl p-4 pr-24 border border-dark-100/50
                    ...
                    group-focus-within:bg-dark-300/70"
                @keydown.enter.exact.prevent="sendMessage"
                @keydown.enter.shift.exact="newLine"
                @keydown.slash="handleSlashCommand"
                :disabled="isLoading"
            ></textarea>
            ...
            <div class="absolute bottom-3 right-3 flex items-center space-x-3">
                ...
                <span class="w-1 h-1 bg-blue-400 rounded-full animate-typing" style="animation-delay: 0.2s"></span>
                <span class="w-1 h-1 bg-blue-400 rounded-full animate-typing" style="animation-delay: 0.4s"></span>
                </div>
                ...
                <button
                type="submit"
                class="p-2 bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:hover:bg-blue-500
                ...
                >
                <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-0 group-hover:opacity-20 translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000"></div>
                <Send class="w-4 h-4 relative transition-transform duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                </button>
            </div>
            </div>
        </form>
