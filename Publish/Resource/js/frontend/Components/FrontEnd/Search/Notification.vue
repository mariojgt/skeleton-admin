    ...
    <div class="relative w-full" tabindex="0">
      ...
      >
        ...
        >
          ...
          <div class="absolute bottom-0 left-0 w-6 h-6 border-b-2 border-l-2 border-[#328AF1] opacity-50 corner-accent"></div>
          <div class="absolute bottom-0 right-0 w-6 h-6 border-b-2 border-r-2 border-[#328AF1] opacity-50 corner-accent"></div>
          ...
          <div class="relative px-4 py-3 border-b border-[#328AF1]/30 flex items-center justify-between z-10">
            ...
            <span class="px-2 py-1 bg-[#328AF1]/10 text-[#328AF1] text-xs rounded-full border border-[#328AF1]/30 rpg-badge">
          ...
          <div class="relative max-h-[32rem] overflow-y-auto rpg-scrollbar z-10">
            ...
            >
              <div class="flex gap-4">
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex items-start justify-between gap-x-2">
                    <p class="text-sm font-medium text-[#BAD9FC] group-hover:text-white transition-colors line-clamp-1">
                      {{ item.data.title }}
                    </p>
                    <time
                      :datetime="item.date"
                      class="text-xs text-[#8B60ED] whitespace-nowrap"
                    >
                      {{ formatDateSimple(item.date) }}
                    </time>
                  </div>
                  <p class="mt-1 text-sm text-[#BAD9FC]/70 group-hover:text-[#BAD9FC] transition-colors line-clamp-2">
                    {{ item.data.content }}
                  </p>
                </div>
              </div>
              ...
              <!-- Hover glow effect -->
              <div class="absolute inset-0 bg-gradient-to-r from-[#328AF1]/5 to-[#8B60ED]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
            </div>
          </div>

          <!-- RPG-Styled Action Button -->
          <div class="relative sticky bottom-0 bg-[#1E2A42]/95 backdrop-blur-sm border-t border-[#328AF1]/30 z-10">
            <button
              @click="readAll"
            ...
            >
              <!-- Button magic glow -->
              <div class="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rpg-button-magic"></div>
        ...
        >
          ...
          <div class="relative z-10">
            <div class="rpg-icon mx-auto mb-3 p-4 rounded-full bg-[#328AF1]/10 border border-[#328AF1]/30 animate-pulse-slow">
              <BellOff
                size="48"
                class="text-[#BAD9FC] opacity-70"
              />
            </div>
