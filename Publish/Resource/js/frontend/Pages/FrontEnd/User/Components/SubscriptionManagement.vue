<template>
    <div class="max-w-7xl mx-auto p-6">
        ...
        <div class="bg-dark-200 shadow rounded-lg p-6 mb-6">
            ...
            >
                <div v-if="usePage().props.authUserInfo?.data?.user_plan?.plan" >
                    <p class="text-lg md:text-xl font-semibold">{{ usePage().props.authUserInfo.data.user_plan.plan.name }}</p>
                    <p class="text-base md:text-lg">
                        Renews on:
                        <span class="text-accent">{{ usePage().props.authUserInfo?.data.user_plan.renovation_at }}</span>
                    </p>
                </div>
            ...
            >
                <p>
                    Next billing amount:
                    <span class="font-bold">${{ usePage().props.authUserInfo?.data.user_plan.plan.price }}</span>
                </p>
